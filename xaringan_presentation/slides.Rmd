...
- Frequentist methods and criticism.

- Bayesian methods and criticism.
...
# Disclaimer: I'm not a frequentist hater.
...
- Frequentist methods: the parameter has a true value, we estimate it via maximum likelihood or other methods.

- Bayesian methods: the parameter has a distribution of possible values. We have prior knowledge, and update the distribution according to the data.
